...
public class OfficeConsult extends JPanel {
    ...
    private void createEvents() {
        ...
        buttonEdit.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
               Browser.officesEdit(currentOffice);
            }
        });
