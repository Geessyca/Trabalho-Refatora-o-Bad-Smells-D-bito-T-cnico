...
<div class="tags" id=”Validacao”><strong>/sistema/Validador .java: </strong>
				<span ng-repeat="tag in tags">
            <a href=""><code class="btn btn-primary btn-xs">Código criado</code></a></span>
  			</div>

Como debito tecnico indentifquei a falta de validação em campos criticos do formulario, então foi criado uma classe para tal prezando a não duplicidade
